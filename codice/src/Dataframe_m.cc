...
void dataframe::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->seqn_var);
    doUnpacking(b,this->genTime_var);
}

int dataframe::getSeqn() const
{
    return seqn_var;
}

void dataframe::setSeqn(int seqn)
{
    this->seqn_var = seqn;
}

double dataframe::getGenTime() const
{
    return genTime_var;
}

void dataframe::setGenTime(double genTime)
{
